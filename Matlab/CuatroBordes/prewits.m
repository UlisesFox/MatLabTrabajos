...
for r=2 : m-1
    for c=2:n-1
        Gx(r,c)=-1*Im(r-1,c-1)-1*Im(r-1,c)-1*Im(r-1,c+1)...
            +1*Im(r+1,c-1)+1*Im(r+1,c)+1*Im(r+1,c+1);
        Gy(r,c)=-1*Im(r-1,c-1)+1*Im(r-1,c+1)-1*Im(r,c-1)...
           +1*Im(r,c+1)-1*Im(r+1,c-1)+1*Im(r+1,c+1);
    end
end
